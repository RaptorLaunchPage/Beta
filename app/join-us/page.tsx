  ...
  return (
    <VideoBackground>
      <div className="relative min-h-screen w-full overflow-x-hidden overflow-y-auto">
        ...
        {/* Main Content */}
        <section id="application-form" className="max-w-6xl mx-auto px-4 pt-24 pb-10">
          <div className="text-center mb-8">
            <FadeInOnScroll>
              <h1 className="text-3xl sm:text-4xl font-extrabold text-white drop-shadow-xl">Join Raptor Esports</h1>
            </FadeInOnScroll>
            <FadeInOnScroll delayMs={120}>
              <p className="mt-2 text-white/85">Your path to the next level starts here.</p>
            </FadeInOnScroll>
